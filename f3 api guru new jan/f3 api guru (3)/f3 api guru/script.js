...
//const urlLocation = "https://api.ipgeolocation.io/ipgeo?apiKey=58b78f57f9a2100051643148b1b162a3"
const urlLocation = "https://api.ipgeolocation.io/ipgeo?ip=223.186.144.199"
...
async function getTimeZone(lat, lon) {
    try {
        const request = await fetch(`https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${lon}&format=json&apiKey=a270c26939f44eaaa43fe245e42308c6`)
...
async function getUpdatedTimeZone(input) {
    try {
        const request = await fetch(`https://api.geoapify.com/v1/geocode/search?text=${input}&format=json&apiKey=a270c26939f44eaaa43fe245e42308c6`)
        const response = await request.json()
        const timeZoneData = response;
